    ...
    <div className={styles.component}>
      ...
      <div className={handleMenu ? styles.side : styles.side_close}>
        ...
        <div className={styles.side_menu}>
          <div>
            <p onClick={() => scrollToTop()}>Top</p>
          </div>
          <div>
            <p onClick={() => scrollToSection(refs.aboutRef)}>About</p>
          </div>
          <div>
            <p onClick={() => scrollToSection(refs.skillRef)}>Skills</p>
          </div>
          <div>
            <p onClick={() => scrollToSection(refs.projectRef)}>Project</p>
          </div>
          <div>
            <p onClick={() => scrollToSection(refs.contactRef)}>Contact</p>
          </div>
        </div>
      </div>
    </div>
